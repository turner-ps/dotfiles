...
Item {
  ...
  readonly property int displayOffDelayMs: 5 * 60 * 1000
  ...
  function focusLockView() {
    Qt.callLater(function() {
      if (root.lockRequested && lockView) lockView.schedulePasswordFocus()
    })
  }
  ...
  Timer {
    id: idleBlankTimer
    interval: root.displayOffDelayMs
    repeat: false
  ...
  IpcHandler {
    ...
    function status(): string {
      return JSON.stringify({
        ...
        displayOffDelayMs: root.displayOffDelayMs,
